...
function buidlEditform(result) {
    var txt =
       "<table style='text-align:left;background-color:white;'><tr><th colspan='2' style ='background-color:#ECEDED' align='left'>Transmission Automation System</th><tr><td>Id:</td><td><div id='Id'>" + result[0].id + "</div></td></tr>" +
       "<tr><td>SiteId:</td><td>" + result[0].SiteId + "</td></tr>" +
       "<tr><td>District:</td><td>" + result[0].District + "</td></tr>" +
       "<tr><td>Cell:</td><td>" + result[0].Cell + "</td></tr>" +
       "<tr><td>Ckt:</td><td>" + result[0].Ckt + "</td></tr>" +
       "<tr><td>EqptatAEnd:</td><td>" + result[0].EqptatAEnd + "</td></tr>" +
       "<tr><td>Port_A:</td><td>" + result[0].Port_A + "</td></tr>" +
       "<tr><td>EqptatBEnd:</td><td>" + result[0].EqptatbEnd + "</td></tr>" +
       "<tr><td>Port_B:</td><td>" + result[0].Port_B + "</td></tr>" +
       "<tr><td>POP:</td><td>" + result[0].POP + "</td></tr>" +
       "<tr><td>Connectivity:</td><td>" + result[0].Connectivity + "</td></tr>" +
       "<tr><td>EngineerName:</td><td>" + result[0].EngineerName + "</td></tr>" +
       "<tr><td>RBL2:</td><td>" + result[0].RBL2 + "</td></tr>" +
       "</table>";
